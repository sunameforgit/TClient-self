...
if(g_Config.m_TcAutoEmoteToggle)
{
	...
	Ui()->DoScrollbarOption(&g_Config.m_TcAutoEmoteInterval, &g_Config.m_TcAutoEmoteInterval, &Button, TCLocalize("Auto emote interval"), 100, 5000, &CUi::ms_LinearScrollbarScale, 0, "ms");
}
...
{
	Column.HSplitTop(LineSize, &Button, &Column);
	Ui()->DoScrollbarOption(&g_Config.m_TcAutoBlinkInterval, &g_Config.m_TcAutoBlinkInterval, &Button, TCLocalize("Auto blink interval"), 100, 5000, &CUi::ms_LinearScrollbarScale, 0, "ms");
}
